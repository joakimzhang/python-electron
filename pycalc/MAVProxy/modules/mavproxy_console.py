...
#thread_obj = Thread(target = show_svo)
show_svo()
...
class ConsoleModule(mp_module.MPModule):
    ...
    def __init__(self, mpstate):
        ...
        mpstate.console.set_status('distance', 'distance', fg='grey', row=0)
        mpstate.console.set_status('position_ned_x', 'posizion_ned_x', fg='grey', row=0)
        mpstate.console.set_status('position_ned_y', 'posizion_ned_y', fg='grey', row=0)
        mpstate.console.set_status('position_ned_z', 'posizion_ned_z', fg='grey', row=0)
